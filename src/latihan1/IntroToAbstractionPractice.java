...
public class IntroToAbstractionPractice {
    public static void main(String[] args) {
        ...
        /*
         * 1. Menghindari instansiasi objek yang terlalu umum.
         * 2. Memaksa subclass untuk mengimplementasikan perilaku spesifik.
         * 3. Memudahkan maintenance dan pengembangan kode.
         * 4. Meningkatkan keamanan dengan menyembunyikan detail implementasi.
         * 5. Mendukung polymorphism sehingga kode lebih fleksibel dan reusable.
         */
